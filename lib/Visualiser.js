    ...
    drawSolutionPath() {
        ...
        this.drawnVisitedPath.forEach(group => {
            if (this.showVisited) {
                ...
                this.ctx.fillRect(group.node.x - this.agentVisitedDotSize / 2, group.node.y - this.agentVisitedDotSize / 2, this.agentVisitedDotSize, this.agentVisitedDotSize);
                currentStep++
            }
            group.neighbours.forEach(xy => {
                ...
                if (this.showNeighbours) {
                    this.ctx.fillRect(xy[0] - this.agentNeighborDotSize / 2, xy[1] - this.agentNeighborDotSize / 2, this.agentNeighborDotSize, this.agentNeighborDotSize)
                    this.ctx.strokeRect(xy[0] - this.agentNeighborDotSize / 2, xy[1] - this.agentNeighborDotSize / 2, this.agentNeighborDotSize, this.agentNeighborDotSize)
                }
                if (this.showEdges) {
                    this.ctx.beginPath()
