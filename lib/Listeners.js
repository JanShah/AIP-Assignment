class Listeners {
    ...
    runSolver() {
        ...
        if (solution && solution.length === 3) {
            ...
            information.pathCost = Number((solution[2]).toFixed(2));
            information.pathLength = Number((solution[1].length * this.grid.agent.resolution).toFixed(2));
            ...
            information.currentsolver = this.currentSolver.name
