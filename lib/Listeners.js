class Listeners {
    ...
    constructor(grid) {
        ...
        this.visualiser.notify = this.observe.bind(this);
        ...
        this.setScreenOverlays = this.#setScreenOverlays.bind(this);
        this.#addListeners();
    ...
    observe(event) {
        if (this[event.target] !== null)
            return this[event.target](event.value);
    ...
    updateQuickSolve(checked) {
        document.getElementById('quickSolve').checked = checked;

    }
    updateAutoSolve(checked) {
        this.#autoSolve = checked;  
        document.getElementById('autoSolve').checked = checked;
    ...
    updateScanDotSize(value) {
        this.visualiser.agentScanDotSize = value;
        document.getElementById('sdSize').innerText = value;
        document.getElementById('scanDotSize').innerText = value;
    }

    #setScreenOverlays() {
        this.visualiser.setScreenOverlays(true)
    }
    ...
    #addListeners() {
        ...
        this.#addListener('screenOverlays', 'click', this.setScreenOverlays)
    ...
    sequenceSlider() {
        ...
        slider.style.width = Math.max(Math.min(window.innerWidth, canvasWidth), 400) + 'px'
