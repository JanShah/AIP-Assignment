class SolutionInformation extends HTMLElement {
    constructor(data) {
        ...
        <section class="timeCost">
            Time: <span>${data.timeCost}</span>ms
        </section>
        <section class="memSize">
            Memory: <span>${data.memSize}</span> bytes
        </section>
        <section class="pathCost">
            Cost: <span>${data.pathCost}</span>
        </section>
        <section class="pathLength">
           Length: <span>${data.pathLength}</span>m
        </section>
        ...
        <section class="currentsolver">
            Solver: <span>${data.currentsolver}</span>
        </section>
        <section class="currentDistanceMetric">
            Heuristic: <span>${data.currentDistanceMetric}</span>
        </section>
        <section class="hWeight">
            Heuristic weight: <span>${data.hWeight}</span>
        </section>
